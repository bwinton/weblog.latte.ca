...
BLOG_AUTHOR = "Blake Winton"  # (translatable)
BLOG_TITLE = "Blog-O!"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "https://bwinton.github.io/weblog.latte.ca/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://weblog.latte.ca/"
BLOG_EMAIL = "bwinton@latte.ca"
BLOG_DESCRIPTION = "A weblog for latte.ca"  # (translatable)
...
style="border-width: 0; vertical-align: bottom"
src="https://licensebuttons.net/l/by-nc-sa/2.5/88x31.png"></a>"""

# A small copyright notice for the page footer (in HTML).
# (translatable)
CONTENT_FOOTER = '<div style="margin-bottom: 12px">Contents &copy; {date}         <a href="mailto:{email}">{author}</a>{license}</div>'
...
<input type="text" name="q" maxlength="255"
 placeholder="Search&hellip;" style="margin-top: 4px;"/>
